 ...
 tabPanel( 
   ...
   fluidRow( 
     column( 
       ...
       checkboxInput("sc1c1split", "Split by time point", value = FALSE),
...
navbarMenu("Fibroblast Subclusters",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
 ...
 tabPanel( 
   ...
   fluidRow( 
     column( 
       ...
       checkboxInput("sc2c1split", "Split by time point", value = FALSE),
...
navbarMenu("Immune Cell Subclusters",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
 ...
 tabPanel( 
   ...
   fluidRow( 
     column( 
       ...
       checkboxInput("sc3c1split", "Split by time point", value = FALSE),
...
navbarMenu("Monocyte-Macrophage Subclusters",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
 ...
 tabPanel( 
   ...
   fluidRow( 
     column( 
       ...
       checkboxInput("sc4c1split", "Split by time point", value = FALSE),
...
br(), 
p("*GENE EXPRESSION DATA", style = "font-size: 125%;"), 
